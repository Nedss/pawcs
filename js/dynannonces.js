document.addEventListener("DOMContentLoaded", function() {
  ...
  //      "<a href='" + annonces[0].photo + "' >" +
  //      "<img src='" + annonces[0].photo +
  //      "' class='img-thumbnail' alt='Photo annonce' title='Cliquez pour aggrandir' />" +
  //      "</a>" +
  //      "</div>" + 
  //      "<div class='col-8 cell-align'>" +
  //      "<div>" +
  //      "<p>" + annonces[0].titre + "</p>" +
  //      "<p>" + annonces[0].categorie + "</p>" +
  //      "<p>" + annonces[0].prix + " euros </p>" +
  //      "<p>" + annonces[0].date_ajout + "</p>" +
  //      "</div>" +
  //      "</div>";
  //    divAnnonce.innerHTML = annonceStructure;
  //  });
  //  requete.open("GET", "get_last.php");
  //  requete.send();
  //  console.log("Last OK");
